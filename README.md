...
1. Then open the Jupyter Notebook instance in Sagemaker and start doing the exercises:
    ...
    4. [Train your models](lab/02_TrainYourModel/01_Training%20our%20model.ipynb): In this exercise you'll use the training pipeline. You'll see how to train or retrain a particular model by just copying a zip file with the required assets to a given S3 bucket.
